...
const sum = exams.reduce((acc, curr) => acc + curr.score, 0);
console.log(sum);
...
const sum = aprobados.reduce((acc, curr) => acc + curr.score, 0);
console.log(sum);

/*6.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().*/

const media = exams.reduce((acc, curr) => acc + curr.score, 0) / exams.length;
console.log(media);
